    			...
    			<div class="card-body">
			        ...
			        <div class="HideThisElement" id="boxInfoDiv">
			        	...
			        	<dl class="row">
		  					...
		  					<dt class="col-sm-1">Capacity:</dt>
		  					<dt class="col-sm-2" id="CapacityText">Capacity</dt>
		  					<dt class="col-sm-1">Space:</dt>
		  					<dt class="col-sm-2" id="SpaceText">Space</dt>
		  					<dt class="col-sm-1">Brand:</dt>
		  					<dt class="col-sm-2" id="BrandText">Brand</dt>
			        	</dl>
...
<script type="text/javascript" src="../JavaScripts/StockIn.js"></script>
