...
<header>
    <div id="mySidenav" class="sidenav">
        ...
        <a href="#">Contact</a> -->
            <!-- Logo -->
              <!--  <a href="http://localhost:8080/Stylrite/JSPs/UserHome.jsp" class="pl-0"><img src="http://localhost:8080/Stylrite/img/CompanyLogo.png" class="CompanyLogo"></a> -->
			<a href="http://localhost:8080/Stylrite/JSPs/UserHome.jsp" style="padding:  0px;margin-left: 6%;"><img style="width: 90%;margin-top: -5%;" src="http://localhost:8080/Stylrite/img/CompanyLogo.png" class="CompanyLogo"></a>
			<!-- <li>
				<ul class="collapsible collapsible-accordion">
					<li id="100001"><a class="collapsible-header waves-effect arrow-r" data-toggle="collapse" data-target="#liHeader1"><i class="fa fa-cogs"></i>Operations <i class="fa fa-angle-down pull-right " ></i></a>
                        <div class="collapse" id="liHeader1">
                            <ul>
                                <li id="100002"><a href="http://localhost:8080/Stylrite/JSPs/Admin/JSPs/Projects.jsp?p=1" class="waves-effect">Project</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li id="100001"><a class="collapsible-header waves-effect arrow-r" data-toggle="collapse" data-target="#liHeader2"><i class="fa fa-star"></i> Evaluation <i class="fa fa-angle-down pull-right"  ></i></a>
                      	 <div class="collapse" id="liHeader2">
                      		<ul>
                      			<li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Admin/JSPs/Projects.jsp?p=2" class="waves-effect">Interview</a>
                                </li>
                                <li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Interview/JSPs/Interview.jsp?p=1" class="waves-effect">Process</a>
                                </li>
                                <li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Interview/JSPs/Format.jsp" class="waves-effect">Format</a>
                                </li>
                      		</ul>
                    	</div>
                    </li>
                    <li id="100001"><a class="collapsible-header waves-effect arrow-r"  data-toggle="collapse" data-target="#liHeader3"><i class="fa fa-eye"></i> Observations <i class="fa fa-angle-down pull-right" ></i></a>
                      	 <div class="collapse" id="liHeader3">
                      		<ul>
                      			<li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Operations/JSPs/Observations.jsp" class="waves-effect">Observations</a>
                                </li>
                                <li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Interview/JSPs/Process.jsp?p=2" class="waves-effect">Process wise Observations</a>
                                </li>
                                <li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Admin/JSPs/Projects.jsp?p=3" class="waves-effect">Project wise Observations</a>
                                </li>
                                <li id="100003"><a href="http://localhost:8080/Stylrite/JSPs/Operations/JSPs/Observations.jsp?d=y" class="waves-effect">Department wise Observations</a>
                                </li>
                      		</ul>
                    	</div>
                    </li>
			...
			<!-- <a href="http://localhost:8080/Stylrite/JSPs/Admin/JSPs/Projects.jsp?p=4&v=m" class="cpc waves-effect">
				<i class="fas fa-angle-double-right"></i>
				My Projects
			</a>
			<a href="http://localhost:8080/Stylrite/JSPs/Admin/JSPs/Projects.jsp?p=4&v=t" class="epc waves-effect">
				<i class="fas fa-angle-double-right"></i>
				Team Projects
			</a>
			<a href="http://localhost:8080/Stylrite/JSPs/POA/JSPs/PlanOfAction.jsp?p=1&v=m" class="cpc waves-effect">
				<i class="fas fa-angle-double-right"></i>
				My POA
			</a>
			<a href="http://localhost:8080/Stylrite/JSPs/POA/JSPs/PlanOfAction.jsp?p=1&v=m" class="epc waves-effect">
				<i class="fas fa-angle-double-right"></i>
				Team POA
			</a>
			<a href="http://localhost:8080/Stylrite/JSPs/Admin/JSPs/Projects.jsp?p=4" class="mg waves-effect">
				<i class="fas fa-angle-double-right"></i>
				All Projects
			</a>
			<a href="http://localhost:8080/Stylrite/JSPs/POA/JSPs/PlanOfAction.jsp" class="mg waves-effect">
				<i class="fas fa-angle-double-right"></i>
				All POA
			</a> -->
