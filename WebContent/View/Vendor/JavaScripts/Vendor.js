...
function formSubmit(type){
	...
	/*if (document.getElementById("firstName").value == "") {
    	...
    	$.ajax({
           type: "POST",
           url: url,
           data: $("#newVendorForm").serialize()+data,
           success: function(data)
           {
               if (data == 1) {
					...
					if(type=="new"){
						document.querySelector('#successMessage').innerHTML = "<strong>Success!</strong> Vendor Registered Successfully !";
						$("#successMessage").removeClass("HideThisElement");
					}else{
						document.querySelector('#successMessage').innerHTML = "<strong>Success!</strong> Vendor Updated Successfully !";
						$("#successMessage").removeClass("HideThisElement");
					}
					...
					if(type=="new"){
						document.querySelector('#errorMessage').innerHTML = "<strong>Error!</strong> Failed to Register New Vendor !";
						$("#errorMessage").removeClass("HideThisElement");
					}else{
						document.querySelector('#errorMessage').innerHTML = "<strong>Error!</strong> Failed to Update New Vendor !";
						$("#errorMessage").removeClass("HideThisElement");
					}
				}
           }
