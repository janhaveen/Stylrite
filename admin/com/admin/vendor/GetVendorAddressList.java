...
@WebServlet("/GetVendorAddressList")
public class GetVendorAddressList extends HttpServlet {
...
//	    HttpSession session = request.getSession();
	    String sql = "SELECT * FROM stylrite_general.detailedvendoraddress where 1=1 ";
