...
/**
 * Servlet implementation class CheckPasswordInfo
 */
...
public class CheckPasswordInfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String sql = "SELECT * FROM stylrite_general.d_employee;";
		...
		try
		{
			...
			while (rs.next()) {
				 ...
				 arrayObj.put("contactNo", rs.getString("mobileNo")==null?"":rs.getString("mobileNo"));
				 arrayObj.put("emailId", rs.getString("emailId")==null?"":rs.getString("emailId"));
				 arrayObj.put("birthdaydate", rs.getString("birthDate")==null?"":rs.getString("birthDate"));
